...
from ..navigator import NavTransitions as navTrans
...
def gamePlaying(player):
    ...
    if (not navTrans.shouldAvoidObstacle(player.brain.nav)):
        player.brain.nav.walk(1, 0, 0)
    if (navTrans.shouldAvoidObstacle(player.brain.nav)):
